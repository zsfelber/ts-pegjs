...
exports.InterpreterRunner = exports.EntryPointInterpreter = exports.DeferredReduce = exports.peg$SUCCESS = exports.peg$FAILED = void 0;
var _1 = require(".");
exports.peg$FAILED = {};
exports.peg$SUCCESS = {};
    ...
    Object.defineProperty(RuleRefInterpreter.prototype, "ruleEntryParser", {
        get: function () {
            if (!this._ruleEntryParser) {
                this._ruleEntryParser = _1.HyperG.ruleInterpreters[this.node.ruleIndex];
                if (!this._ruleEntryParser) {
...
var TerminalRefInterpreter = /** @class */ (function (_super) {
    ...
    TerminalRefInterpreter.prototype.checkConstructFailed = function () {
        var dirty = _super.prototype.checkConstructFailed.call(this);
        if (_1.HyperG.Env === _1.HyperGEnvType.ANALYZING) {
...
var InterpreterRunner = /** @class */ (function () {
    function InterpreterRunner(owner) {
        this.owner = owner;
        this.packrat = new _1.Packrat(owner);
