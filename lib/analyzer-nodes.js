...
var ChoiceTraverser = /** @class */ (function (_super) {
    ...
    ChoiceTraverser.prototype.traversionGeneratorEnter = function (inTraversion) {
        ...
        if (this.terminalChoice) {
            this.stateNode = new analyzer_1.TerminalChoiceLeafStateNode(this);
    ...
    ChoiceTraverser.prototype.traversionActions = function (inTraversion, step, cache) {
        switch (step.kind) {
            case analyzer_tra_1.TraversionItemKind.NODE_START:
                    ...
                    case analyzer_tra_1.TraversionPurpose.FIND_NEXT_TOKENS:
                        if (traverseLocals.steppingFromInsideThisSequence) {
                            ...
                            if (step.kind === analyzer_tra_1.TraversionItemKind.NODE_END) {
                                ...
                                inTraversion.execute(analyzer_tra_1.TraversionItemActionKind.OMIT_SUBTREE, step.end);
                            }
                        }
                        break;
                    case analyzer_tra_1.TraversionPurpose.BACKSTEP_TO_SEQUENCE_THEN:
...
var RuleRefTraverser = /** @class */ (function (_super) {
    ...
    RuleRefTraverser.prototype.traversionGeneratorEnter = function (inTraversion) {
        var recursiveRule = analyzer_tra_1.Traversing.recursionCacheStack["rule_ref#" + this.targetRule.nodeIdx];
        if (this.stateNode)
            throw new Error("There is a stateNode already : " + this + "  stateNode:" + this.stateNode);
        var deferred = _1.Analysis.deferredRules.indexOf(this.targetRule.rule) !== -1;
        if (deferred) {
        ...
        if (!this.isDeferred) {
            if (this.targetRule.refs > 1) {
                ...
                this.isDeferred = true;
                delete analyzer_tra_1.Traversing.recursionCacheStack["rule_ref#" + this.targetRule.nodeIdx];
            }
            else {
                // NOTE
                // IT IS CUT off now  !!!
                ...
                if (false) {
                    ...
                    var estCntNodes = analyzer_tra_1.Traversing.recursionCacheStack.parent.upwardBranchCnt *
                        cntNodesL1;
        ...
        if (this.isDeferred) {
            ...
            analyzer_tra_1.Traversing.recursionCacheStack["rule_ref#" + this.targetRule.nodeIdx] = this;
...
var EntryPointTraverser = /** @class */ (function (_super) {
    ...
    EntryPointTraverser.prototype.traversionGeneratorEnter = function (inTraversion) {
        var ruleOriginal = analyzer_tra_1.Traversing.recursionCacheStack["rule_ref#" + this.node.nodeIdx];
        if (!ruleOriginal) {
            analyzer_tra_1.Traversing.recursionCacheStack["rule_ref#" + this.node.nodeIdx] = this.node;
        }
        return true;
    };
