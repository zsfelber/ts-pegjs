                ...
                switch (inTraversion.purpose) {
                    case _1.TraversionPurpose.FIND_NEXT_TOKENS:
                        if (traverseLocals.steppingFromInsideThisSequence) {
                            ...
                            //
                            if (!step.previousChild.optionalBranch) {
                                inTraversion.execute(_1.TraversionItemActionKind.OMIT_SUBTREE, step);
                            }
                        }
                        break;
                    case _1.TraversionPurpose.BACKSTEP_TO_SEQUENCE_THEN:
...
var OrMoreTraverser = /** @class */ (function (_super) {
    ...
    OrMoreTraverser.prototype.pushPrefixControllerItem = function (inTraversion) {
        this.crrTrItem = new _1.TraversionControl(inTraversion, _1.TraversionItemKind.REPEAT, this);
    };
    ...
    OrMoreTraverser.prototype.traversionActions = function (inTraversion, step, cache) {
        switch (step.kind) {
            case _1.TraversionItemKind.REPEAT:
                switch (inTraversion.purpose) {
                    case _1.TraversionPurpose.FIND_NEXT_TOKENS:
                        break;
                    case _1.TraversionPurpose.BACKSTEP_TO_SEQUENCE_THEN:
...
var RuleRefTraverser = /** @class */ (function (_super) {
    ...
    function RuleRefTraverser(parser, parent, node) {
        ...
        _this.targetRule = _1.Analysis.ruleTable[_this.node.ruleIndex];
        return _this;
    }
    ...
    RuleRefTraverser.prototype.checkConstructFailed = function () {
        ...
        this.targetRule = _1.Analysis.ruleTable[this.node.ruleIndex];
        if (!this.targetRule) {
    ...
    RuleRefTraverser.prototype.traversionGeneratorEnter = function (inTraversion) {
        ...
        if (!this.isDeferred) {
            ...
            if (cntNodes >= _1.MAX_CNT_BRANCH_NODES) {
                console.warn("Auto defer big rule : " + this + " in " + inTraversion + "  its nodes:" + cntNodes);
                if (!_1.Analysis["consideredManualDefer"]) {
                    _1.Analysis["consideredManualDefer"] = true;
                    console.warn("  Consider configuring deferred rules manually for your code esthetics.\n" +
        ...
        if (this.isDeferred) {
            this.traverserStep = new _1.TraversionControl(inTraversion, _1.TraversionItemKind.DEFERRED_RULE, this);
            ...
            this.traverserStep = new _1.TraversionControl(inTraversion, _1.TraversionItemKind.RULE, this);
            inTraversion.pushControl(this.traverserStep);
            return true;
        }
    };
    ...
    RuleRefTraverser.prototype.traversionActions = function (inTraversion, step, cache) {
        switch (step.kind) {
            case _1.TraversionItemKind.DEFERRED_RULE:
                switch (inTraversion.purpose) {
                    case _1.TraversionPurpose.FIND_NEXT_TOKENS:
                        cache.intoState.shiftsAndReduces.push({ kind: _1.ShiftReduceKind.SHIFT_RECURSIVE, item: this });
                        inTraversion.execute(_1.TraversionItemActionKind.STOP, step);
                        break;
                    case _1.TraversionPurpose.BACKSTEP_TO_SEQUENCE_THEN:
                        break;
...
var TerminalRefTraverser = /** @class */ (function (_super) {
    ...
    TerminalRefTraverser.prototype.pushPrefixControllerItem = function (inTraversion) {
        ...
        this.parser.allLeafStateNodes.push(this.stateNode);
        this.traverserStep = new _1.TraversionControl(inTraversion, _1.TraversionItemKind.TERMINAL, this);
        inTraversion.pushControl(this.traverserStep);
    };
    TerminalRefTraverser.prototype.traversionActions = function (inTraversion, step, cache) {
        switch (step.kind) {
            case _1.TraversionItemKind.TERMINAL:
                switch (inTraversion.purpose) {
                    case _1.TraversionPurpose.FIND_NEXT_TOKENS:
                        cache.intoState.shiftsAndReduces.push({ kind: _1.ShiftReduceKind.SHIFT, item: this });
                        break;
                    case _1.TraversionPurpose.BACKSTEP_TO_SEQUENCE_THEN:
                        break;
                }
