...
var RuleElementTraverser = /** @class */ (function () {
    ...
    Object.defineProperty(RuleElementTraverser.prototype, "isTerminalRefOrChoice", {
        get: function () {
            return false;
        },
        enumerable: false,
...
var ChoiceTraverser = /** @class */ (function (_super) {
    ...
    function ChoiceTraverser(parser, parent, node) {
        ...
        _this.terminalChoice = !_this.children.some(function (itm) { return !itm.isTerminalRefOrChoice; });
        return _this;
    }
    ...
    Object.defineProperty(ChoiceTraverser.prototype, "isTerminalRefOrChoice", {
        get: function () {
    ...
    ChoiceTraverser.prototype.traversionGeneratorEnter = function (inTraversion) {
        if (this.stateNode)
            throw new Error("There is a stateNode already : " + this + "  stateNode:" + this.stateNode);
        if (this.terminalChoice) {
            this.stateNode = new _1.TerminalChoiceLeafStateNode(this);
            this.traverserPosition = inTraversion.length;
            this.parser.allLeafStateNodes.push(this.stateNode);
            this.node._tokenId = _1.Analysis.cntChoiceTknIds--;
            _1.Analysis.choiceTokens[-this.node._tokenId] = this.node;
            return false;
        }
        else {
            return true;
    ...
    ChoiceTraverser.prototype.traversionActions = function (inTraversion, step, cache) {
        switch (step.kind) {
            case _1.TraversionItemKind.NODE_START:
                switch (inTraversion.purpose) {
                    case _1.TraversionPurpose.FIND_NEXT_TOKENS:
                        if (this.stateNode) {
                            cache.intoState.common.shiftsAndReduces.push({ kind: _1.ShiftReduceKind.SHIFT, item: this });
                        }
                        break;
                    case _1.TraversionPurpose.BACKSTEP_TO_SEQUENCE_THEN:
                        break;
                }
                break;
            default:
    ...
    Object.defineProperty(ChoiceTraverser.prototype, "shortLabel", {
        get: function () {
...
var SequenceTraverser = /** @class */ (function (_super) {
    ...
    SequenceTraverser.prototype.traversionActions = function (inTraversion, step, cache) {
        ...
        switch (step.kind) {
            case _1.TraversionItemKind.CHILD_SEPARATOR:
            case _1.TraversionItemKind.NODE_END:
                switch (inTraversion.purpose) {
                    case _1.TraversionPurpose.FIND_NEXT_TOKENS:
                        if (traverseLocals.steppingFromInsideThisSequence) {
                            ...
                            if (step.previousChild.optionalBranch) {
                                if (step.kind === _1.TraversionItemKind.NODE_END) {
                                    // FINISH
                                    // change purpose
                                    inTraversion.execute(_1.TraversionItemActionKind.CHANGE_PURPOSE, step, _1.TraversionPurpose.BACKSTEP_TO_SEQUENCE_THEN, [_1.TraversionPurpose.FIND_NEXT_TOKENS]);
                                }
                            }
                            else {
                                inTraversion.execute(_1.TraversionItemActionKind.STOP, step);
                            }
                        }
                        else {
                            ...
                            if (step.kind === _1.TraversionItemKind.NODE_END) {
                                ...
                                inTraversion.execute(_1.TraversionItemActionKind.OMIT_SUBTREE, step.end);
                            }
                        }
                        break;
                    case _1.TraversionPurpose.BACKSTEP_TO_SEQUENCE_THEN:
                        if (step.kind === _1.TraversionItemKind.NODE_END) {
                            ...
                            if (step.child.common) {
                                ...
                                cache.intoState.common = step.child.common;
                                inTraversion.execute(_1.TraversionItemActionKind.STEP_PURPOSE, step);
                            }
                        }
                        break;
                }
                ...
                switch (inTraversion.purpose) {
                    ...
                    case _1.TraversionPurpose.BACKSTEP_TO_SEQUENCE_THEN:
                        if (this.common) {
                            ...
                            cache.intoState.common = this.common;
                            inTraversion.execute(_1.TraversionItemActionKind.RESET_POSITION, step);
                            inTraversion.execute(_1.TraversionItemActionKind.STEP_PURPOSE, step);
                        }
                        break;
                }
...
var RuleRefTraverser = /** @class */ (function (_super) {
    ...
    RuleRefTraverser.prototype.lazyBuildMonoRefTree = function () {
        var deferred = _1.Analysis.startRules.indexOf(this.targetRule.rule) !== -1;
    ...
    RuleRefTraverser.prototype.traversionGeneratorEnter = function (inTraversion) {
        ...
        if (!this.isDeferred) {
            if (this.targetRule.refs > 1) {
                _1.Analysis.startRules.push(this.targetRule.rule);
                this.isDeferred = true;
                ...
                if (false) {
                    ...
                    var cntNodesLN = this.linkedRuleEntry.hubSize(_1.CNT_HUB_LEVELS);
                    var estCntNodes = _1.Traversing.recursionCacheStack.parent.upwardBranchCnt *
                        cntNodesL1;
                    if (cntNodesLN >= _1.LEV_CNT_LN_RULE && estCntNodes >= _1.LEV_CNT_BRANCH_NODES) {
...
var TerminalRefTraverser = /** @class */ (function (_super) {
    ...
    Object.defineProperty(TerminalRefTraverser.prototype, "isTerminalRefOrChoice", {
        get: function () {
            return true;
        },
        enumerable: false,
    ...
    TerminalRefTraverser.prototype.traversionGeneratorEnter = function (inTraversion) {
        if (this.stateNode)
            throw new Error("There is a stateNode already : " + this + "  stateNode:" + this.stateNode);
        ...
        if (maxLev > 0)
            this.allRuleReferences.forEach(function (rr) {
                ...
                if (rr.linkedRuleEntry !== _this) {
                    var deferred = _1.Analysis.startRules.indexOf(rr.targetRule.rule) !== -1;
                    if (!deferred) {
...
var PredicateNotTraverser = /** @class */ (function (_super) {
    ...
    PredicateNotTraverser.prototype.traversionGeneratorEnter = function (inTraversion) {
        var action = new _1.TraversionControl(inTraversion, _1.TraversionItemKind.NEGATE, this);
        inTraversion.pushControl(action);
        return true;
    };
    PredicateNotTraverser.prototype.traversionGeneratorExited = function (inTraversion) {
        var action = new _1.TraversionControl(inTraversion, _1.TraversionItemKind.NEGATE, this);
        inTraversion.pushControl(action);
    };
