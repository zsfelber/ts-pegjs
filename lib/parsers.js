...
function countRuleRefs() {
    _1.HyperG.ruleRefTable.forEach(function (rr) {
        _1.HyperG.ruleTable[rr.ruleIndex].refs++;
    });
}
exports.countRuleRefs = countRuleRefs;
var PNode = /** @class */ (function () {
    ...
    PNode.prototype.deser = function (arr, pos) {
        ...
        if (_1.HyperG.Env === index_1.HyperGEnvType.INTEGRITY_CHECK_VERBOSE) {
