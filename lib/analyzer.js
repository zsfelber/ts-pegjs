...
var TraversionControl = /** @class */ (function () {
    ...
    Object.defineProperty(TraversionControl.prototype, "nodeTravId", {
        get: function () {
...
var LinearTraversion = /** @class */ (function () {
    ...
    LinearTraversion.prototype.createRecursively = function (item, recursionCacheStack) {
        ...
        item.children.forEach(function (child) {
            if (item.checkLoopIsFinitePrefix(_this, child, newRecursionStack)) {
                var separator;
                if (first) {
                    first = 0;
                }
                ...
                previousChild = child;
                item.checkLoopIsFinitePostfix(_this, child, newRecursionStack);
            }
        });
...
var RuleElementTraverser = /** @class */ (function () {
    ...
    RuleElementTraverser.prototype.checkLoopIsFinitePrefix = function (inTraversion, childPending, recursionCacheStack) {
        return true;
    };
    RuleElementTraverser.prototype.checkLoopIsFinitePostfix = function (inTraversion, childPending, recursionCacheStack) {
    };
...
var RuleRefTraverser = /** @class */ (function (_super) {
    ...
    function RuleRefTraverser(parser, parent, node) {
        ...
        _this.optionalBranch = _this.linkedRuleEntry.optionalBranch;
        return _this;
    }
    ...
    RuleRefTraverser.prototype.checkLoopIsFinitePrefix = function (inTraversion, childPending, recursionCacheStack) {
