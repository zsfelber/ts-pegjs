...
(function (Analysis) {
    var Backup = /** @class */ (function () {
        ...
        Backup.prototype.load = function () {
            ...
            this.leafStateCommons = Analysis.leafStateCommons;
            ...
            this.serializedLeafStates = Analysis.serializedLeafStates;
            this.serializedStateCommons = Analysis.serializedStateCommons;
            ...
            this.parseTables = Analysis.parseTables;
            this.varShs = Analysis.varShs;
            this.varShReqs = Analysis.varShReqs;
            this.varTkns = Analysis.varTkns;
            this.varRds = Analysis.varRds;
        };
    ...
    function writeAllSerializedTables(buf) {
        ...
        var slf = Object.values(Analysis.serializedLeafStates);
...
var ParseTableGenerator = /** @class */ (function () {
    ...
    ParseTableGenerator.prototype.generateParseTable = function () {
        if (!this.generatedResult) {
            ...
            this.generatedResult = new analyzer_rt_1.ParseTable(this.rule, start, all);
        }
