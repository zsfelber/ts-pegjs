...
(function (Analysis) {
    var Backup = /** @class */ (function () {
        function Backup() {
            ...
            this.varDeep = new index_1.IncVariator();
        }
        Backup.prototype.load = function () {
            ...
            this.varDeep = new index_1.IncVariator(Analysis.varDeep);
        };
    ...
    Analysis.varDeep = new index_1.IncVariator();
    function backup() {
    ...
    function writeAllSerializedTables(buf) {
        ...
        var ctk0 = Object.values(Analysis.choiceTokens);
        ...
        var ctk = index_1.distinct(ctk0, function (a, b) {
