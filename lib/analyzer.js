...
exports.EntryPointTraverser = exports.CopiedRuleTraverser = exports.RuleTraverser = exports.RuleElementTraverser = exports.GrammarParsingLeafState = exports.RTShift = exports.ParseTable = exports.ParseTableGenerator = exports.MAX_CNT_BRANCH_NODES = exports.START_STATE = exports.FAIL_STATE = exports.Analysis = void 0;
var _1 = require(".");
...
(function (Traversing) {
    ...
    function start(_inTraversion, _item) {
        ...
        Traversing.recursionCacheStack = { depth: 0, indent: "", item: _item };
    ...
    function push(child) {
        ...
        Traversing.recursionCacheStack = { depth: oldRecursionCacheStack.depth + 1, indent: oldRecursionCacheStack.indent + "  ", parent: oldRecursionCacheStack, top: oldRecursionCacheStack.top, item: child };
        if (Traversing.recursionCacheStack.depth > maxdepth) {
            maxdepth = Traversing.recursionCacheStack.depth;
            if (!(maxdepth % 10)) {
                console.log("Traversal depth:" + Traversing.recursionCacheStack.depth);
            }
        }
        Traversing.item = Traversing.recursionCacheStack.item;
...
exports.MAX_CNT_BRANCH_NODES = 500;
var Factory;
(function (Factory) {
    Factory.parseTables = {};
...
var RuleElementTraverser = /** @class */ (function () {
    ...
    Object.defineProperty(RuleElementTraverser.prototype, "branchSize", {
        get: function () {
            var result = 0;
...
var RuleRefTraverser = /** @class */ (function (_super) {
    ...
    Object.defineProperty(RuleRefTraverser.prototype, "branchSize", {
        get: function () {
    ...
    RuleRefTraverser.prototype.traversionGeneratorEnter = function (inTraversion) {
        ...
        if (!this.isDeferred) {
            ...
            if (cntNodes >= exports.MAX_CNT_BRANCH_NODES) {
...
var TerminalRefTraverser = /** @class */ (function (_super) {
    ...
    Object.defineProperty(TerminalRefTraverser.prototype, "branchSize", {
        get: function () {
            return 1;
        },
        enumerable: false,
...
var CopiedRuleTraverser = /** @class */ (function (_super) {
    ...
    function CopiedRuleTraverser(parser, parent, node) {
        ...
        if (!parent)
            throw new Error();
        _this.allNodes = {};
        _this.allNodes[_this.nodeTravId] = _this;
        return _this;
    }
