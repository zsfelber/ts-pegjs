...
var RuleElementTraverser = /** @class */ (function () {
    ...
    RuleElementTraverser.prototype.shortLabel = function () {
...
var ZeroOrMoreTraverser = /** @class */ (function (_super) {
    ...
    ZeroOrMoreTraverser.prototype.shortLabel = function () {
...
var OneOrMoreTraverser = /** @class */ (function (_super) {
    ...
    OneOrMoreTraverser.prototype.shortLabel = function () {
        return (this.node.label ? this.node.label + ":" : "") + "+";
    };
...
var RuleRefTraverser = /** @class */ (function (_super) {
    ...
    RuleRefTraverser.prototype.shortLabel = function () {
...
var TerminalRefTraverser = /** @class */ (function (_super) {
    ...
    TerminalRefTraverser.prototype.shortLabel = function () {
...
var EntryPointTraverser = /** @class */ (function (_super) {
    ...
    EntryPointTraverser.prototype.shortLabel = function () {
        return (this.node.label ? this.node.label + ":" : "") + this.node.rule;
    };
