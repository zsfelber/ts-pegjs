...
(function (Traversing) {
    function start(_inTraversion, _item) {
        ...
        Traversing.recursionCacheStack = { indent: "", item: _item };
    ...
    function push(child) {
        ...
        Traversing.recursionCacheStack = { indent: oldRecursionCacheStack.indent + "  ", parent: oldRecursionCacheStack, item: child };
        Traversing.item = Traversing.recursionCacheStack.item;
        ...
        if (this.importPoint) {
            if (this.importPoint.allNodes) {
                ...
                if (cntNodes >= exports.MAX_CNT_BRANCH_NODES) {
                    throw { "anApple": exports.MAX_CNT_BRANCH_NODES, "anOrange": 1 };
                }
            }
        }
        else {
    ...
    RuleRefTraverser.prototype.traversionGeneratorEnter = function (inTraversion) {
        ...
        if (!this.isDeferred) {
            ...
            try {
                ...
                if (somethg.anApple === exports.MAX_CNT_BRANCH_NODES && somethg.anOrange) {
                    console.warn("Auto defer, rule is too big : " + this + " in " + inTraversion + "  number of its nodes:" + exports.MAX_CNT_BRANCH_NODES);
