...
var RootStateNodeCommon = /** @class */ (function (_super) {
    ...
    RootStateNodeCommon.prototype.generateState = function (parseTable) {
...
var LeafStateNodeCommon = /** @class */ (function (_super) {
    ...
    LeafStateNodeCommon.prototype.generateState = function (parseTable) {
...
var ParseTableGenerator = /** @class */ (function () {
    ...
    ParseTableGenerator.prototype.generateParseTable = function () {
        if (!this.generatedResult) {
            this.generatedResult = new analyzer_rt_1.ParseTable(this.rule, this);
        }
