...
exports.EntryPointTraverser = exports.CopiedRuleTraverser = exports.RuleTraverser = exports.RuleElementTraverser = exports.GrammarParsingLeafState = exports.ParseTable = exports.ParseTableGenerator = exports.FINAL_STATE = exports.START_STATE = exports.FAIL_STATE = exports.Analysis = void 0;
var _1 = require(".");
        ...
        switch (node.kind) {
            ...
            case _1.PNodeKind.RULE:
                if (!parent) {
                    ...
                    return new CopiedRuleTraverser(parser, parent, node);
                }
                else {
...
var ParseTable = /** @class */ (function () {
    ...
    ParseTable.prototype.deser = function (buf) {
        var maxIdx = 0;
        var ridx = buf[0], stlen = buf[1], mxtki = buf[2], maxIdx = buf[3];
...
var GrammarParsingLeafState = /** @class */ (function () {
    ...
    GrammarParsingLeafState.prototype.deser = function (maxTknId, index, buf, pos) {
        var isrl = buf[0], sndx = buf[1], rlen = buf[2], erlen = buf[3];
        this.isRule = isrl === 1;
        this.index = index;
        ...
        switch (inTraversion.purpose) {
            case TraversionPurpose.FIND_NEXT_TOKENS:
                switch (step.kind) {
                    case TraversionItemKind.DEFERRED_RULE:
                        if (!this.isDeferred)
                            throw new Error("State error, it should be deferred or non-deferred :" + this);
