...
var PegjsParseStream = /** @class */ (function () {
    function PegjsParseStream(buffer, ruleNames, initialPos) {
...
var PegjsParseStreamBuffer = /** @class */ (function () {
    function PegjsParseStreamBuffer(src, offset) {
    ...
    PegjsParseStreamBuffer.prototype.seek = function (position, rule) {
        /*
    ...
    * meaning lookahead tokens */
    ...
    PegjsParseStreamBuffer.prototype.substring = function (from, to, rule) {
        if (to === undefined)
            to = -1;
        if (to < 0)
    ...
    PegjsParseStreamBuffer.prototype.substr = function (from, len, rule) {
        return this.substring(from, len === undefined ? undefined : from + len, rule);
    };
...
var PegjsTknParseStreamBuffer = /** @class */ (function (_super) {
    ...
    function PegjsTknParseStreamBuffer(src, offset, initialTokens) {
        var _this = _super.call(this, src, offset) || this;
        if (src instanceof PegjsTknParseStreamBuffer) {
            _this.tokens = offset ? src.tokens.slice(offset) : src.tokens;
        }
        else {
            _this.tokens = offset ? initialTokens.slice(offset) : initialTokens;
        }
        return _this;
    }
