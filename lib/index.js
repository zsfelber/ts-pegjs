...
(function (HyperG) {
    ...
    HyperG.nodeTable = [];
    function serializerTransaction(tmpSerializerIdx, fun) {
        var olds = HyperG.serializerCnt;
        try {
            HyperG.serializerCnt = tmpSerializerIdx;
            fun();
        }
        finally {
            HyperG.serializerCnt = olds;
        }
    }
    HyperG.serializerTransaction = serializerTransaction;
...
function checkRuleNodeIntegrity(ruleNode, serializedForm) {
    ...
    if (hex !== serializedForm) {
        ...
        HyperG.serializerTransaction(ruleNode.nodeIdx, function () {
...
exports.checkRuleNodeIntegrity = checkRuleNodeIntegrity;
function checkConstTableIntegrity(serializedConstTable) {
    HyperG.serializerCnt = HyperG.serializerStartingIdx;
    var ttbuf = [];
...
exports.checkConstTableIntegrity = checkConstTableIntegrity;
function checkParseTablesIntegrity(items) {
    HyperG.serializerCnt = HyperG.serializerStartingIdx;
    items.forEach(function (_a) {
...
exports.checkParseTableIntegrity = checkParseTableIntegrity;
