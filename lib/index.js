...
(function (HyperG) {
    var Backup = /** @class */ (function () {
        ...
        Backup.prototype.load = function () {
            ...
            this.ruleRefTable = HyperG.ruleRefTable;
            this.parseTables = HyperG.parseTables;
            this.indent = HyperG.indent;
            this.stack = HyperG.stack;
        };
...
function checkParseTableIntegrity(parseTable, serializedForm, mode) {
    ...
    var parseTable2 = new analyzer_rt_1.ParseTable(parseTable.rule, null, []);
