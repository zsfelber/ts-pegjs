...
exports.PegjsTknParseStreamBuffer = exports.PegjsParseStreamBuffer = exports.PegjsParseStream = exports.DefaultTracer = exports.SyntaxError = exports.PegjsParseErrorInfo = void 0;
...
var DefaultTracer = /** @class */ (function () {
    function DefaultTracer(startTracingOnly) {
        this.indentLevel = 0;
        if (startTracingOnly && !Object.keys(startTracingOnly).length)
            startTracingOnly = null;
        this.startTracingOnly = startTracingOnly;
        if (!startTracingOnly)
            this.started = { atindent: -1 };
    }
    DefaultTracer.prototype.trace = function (event) {
        var that = this;
        function log(evt, blocktxt) {
            ...
            if (typeof console === "object") { // IE 8-10
                console.log("/* " + pad(evt.location.start.line + ":" + evt.location.start.column + "-"
                    + evt.location.end.line + ":" + evt.location.end.column + " "
                    + evt.type + "  " + (evt.cached ? "C" : ""), 23) + " "
