...
exports.PCallArg = exports.PFunction = exports.PNode = exports.PNodeKind = exports.JSstringEscape = exports.PegjsSeekableParseBuffer = exports.PegjsParseStreamBuffer = exports.PegjsParseStream = exports.DefaultTracer = exports.SyntaxError = exports.PegjsParseErrorInfo = exports.mergeLocalFailures = exports.mergeFailures = exports.ACCEPT_TOKEN = exports.MATCH_TOKEN = void 0;
...
var PegjsParseStreamBuffer = /** @class */ (function () {
    ...
    PegjsParseStreamBuffer.prototype.isAvailableAt = function (position) {
...
var PegjsSeekableParseBuffer = /** @class */ (function (_super) {
    __extends(PegjsSeekableParseBuffer, _super);
    function PegjsSeekableParseBuffer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PegjsSeekableParseBuffer.prototype.seek = function (position) {
        /*
    ...
    PegjsSeekableParseBuffer.prototype.isAvailableAt = function (position) {
        this.seek(position);
        return this.buffer.length > position;
    };
    /* these should read forward if requested position is in the future
    * meaning lookahead tokens */
    PegjsSeekableParseBuffer.prototype.charAt = function (position) {
        this.seek(position);
        return this.buffer.charAt(position);
    };
    PegjsSeekableParseBuffer.prototype.charCodeAt = function (position) {
        this.seek(position);
        return this.buffer.charCodeAt(position);
    };
    PegjsSeekableParseBuffer.prototype.substring = function (from, to) {
        this.seek(to);
        return this.buffer.substring(from, to);
    };
    PegjsSeekableParseBuffer.prototype.substr = function (from, len) {
        this.seek(len < 0 ? this.buffer.length - 1 : from + len);
        return this.buffer.substr(from, len);
    };
    return PegjsSeekableParseBuffer;
}(PegjsParseStreamBuffer));
exports.PegjsSeekableParseBuffer = PegjsSeekableParseBuffer;
...
var PNodeKind;
(function (PNodeKind) {
    PNodeKind[PNodeKind["GRAMMAR"] = 0] = "GRAMMAR";
    PNodeKind[PNodeKind["RULE"] = 1] = "RULE";
    PNodeKind[PNodeKind["CHOICE"] = 2] = "CHOICE";
    PNodeKind[PNodeKind["SEQUENCE"] = 3] = "SEQUENCE";
    PNodeKind[PNodeKind["OPTIONAL"] = 4] = "OPTIONAL";
    PNodeKind[PNodeKind["ONE_OR_MORE"] = 5] = "ONE_OR_MORE";
    PNodeKind[PNodeKind["ZERO_OR_MORE"] = 6] = "ZERO_OR_MORE";
    PNodeKind[PNodeKind["SINGLE"] = 7] = "SINGLE";
    PNodeKind[PNodeKind["SEMANTIC_AND"] = 8] = "SEMANTIC_AND";
    PNodeKind[PNodeKind["SEMANTIC_NOT"] = 9] = "SEMANTIC_NOT";
    PNodeKind[PNodeKind["RULE_REF"] = 10] = "RULE_REF";
    PNodeKind[PNodeKind["TERMINAL_REF"] = 11] = "TERMINAL_REF";
