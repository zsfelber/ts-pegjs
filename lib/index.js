...
(function (HyperG) {
    var Backup = /** @class */ (function () {
        ...
        Backup.prototype.load = function () {
            ...
            this.parseTables = Object.assign({}, HyperG.parseTables);
    ...
    function totallyReinitializableTransaction(fun) {
        var bak = analyzer_1.Analysis.backup();
        var e = backup();
        try {
            fun();
        }
...
function checkRuleNodeIntegrity(ruleNode, serializedForm, mode) {
    ...
    HyperG.totallyReinitializableTransaction(function () {
        ...
        var node = parsers_1.PNode.deserialize(code);
        var ruleNode2 = node;
...
function checkParseTablesIntegrity(serializedConstTable, items, mode) {
    HyperG.totallyReinitializableTransaction(function () {
        analyzer_1.Analysis.empty().save();
        HyperG.Env = mode ? mode : HyperGEnvType.INTEGRITY_CHECK;
        HyperG.serializerCnt = HyperG.serializerStartingIdx;
        items.forEach(function (_a) {
        ...
        var ttbuf = [];
        analyzer_1.Analysis.writeAllSerializedTables(ttbuf);
...
function checkParseTableIntegrity(parseTable, serializedForm, mode) {
    ...
    var parseTable2 = new analyzer_rt_1.ParseTable(parseTable.rule);
...
__exportStar(require("./analyzer-rt"), exports);
