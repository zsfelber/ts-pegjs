    ...
    JumpTableRunner.prototype.run = function (withToken) {
        ...
        var _loop_1 = function () {
            ...
            var pushShift = function (newShifts, stack, action) {
                ...
                // 1 - based
                currentStates = newShifts.map(function (shift) { return (_this.parseTable.allStates[shift.toStateIndex - 1]); });
                token = owner.next();
                i = 0;
            };
            var hasRecursionSucceeded = function (rsh) {
                // 1 - based
                var reqstate = (_this.parseTable.allStates[rsh.toStateIndex - 1]);
