...
(function (HyperG) {
    var Backup = /** @class */ (function () {
        ...
        Backup.prototype.load = function () {
            this.Env = HyperG.Env;
            this.anal = _1.Analysis.backup();
            this.serializerStartingIdx = HyperG.serializerStartingIdx;
            this.serializerCnt = HyperG.serializerCnt;
            this.functionTable = Object.assign([], HyperG.functionTable);
            this.ruleTable = Object.assign([], HyperG.ruleTable);
            this.ruleInterpreters = Object.assign([], HyperG.ruleInterpreters);
            this.nodeTable = Object.assign([], HyperG.nodeTable);
            this.ruleRefTable = Object.assign([], HyperG.ruleRefTable);
            this.indent = HyperG.indent;
            this.stack = Object.assign([], HyperG.stack);
        };
...
var DefaultComparator = function (a, b) {
    ...
    if (typeof (a) === "number" && typeof (b) === "number") {
        ...
        return a[exports.UNIQUE_OBJECT_INDEX] - b[exports.UNIQUE_OBJECT_INDEX];
    }
};
exports.DefaultComparator = DefaultComparator;
exports.UNIQUE_OBJECT_INDEX = "_uniqueObjIndex";
exports.UNIQUE_OBJECT_ID = "_uniqueObjId";
// static
var cnt_uniqueObjId = 1000;
if (!Object.prototype.hasOwnProperty(exports.UNIQUE_OBJECT_ID)) {
    Object.defineProperty(Object.prototype, exports.UNIQUE_OBJECT_INDEX, {
...
function indexOfArray(arr, value, from, cmp) {
    var res = -1;
    if (!cmp)
...
function removeArrayItemMore(arr, value, cmp) {
    var itms = 0;
    if (!cmp)
        cmp = exports.DefaultComparator;
...
exports.removeArrayItemMore = removeArrayItemMore;
function minimum(inparr0, cmp) {
    if (!inparr0)
        return [-1, undefined];
    var inparr = Object.values(inparr0);
    if (!inparr.length)
        return [-1, undefined];
    if (!cmp) {
        cmp = exports.DefaultComparator;
...
function distinctIndexed(inparr0, indexer) {
    if (!inparr0)
        return inparr0;
    var inparr = Object.values(inparr0);
    var resarr = [];
...
exports.distinctIndexed = distinctIndexed;
function groupBy(inparr0, cmp) {
    if (!inparr0)
        return inparr0;
    if (!cmp) {
        cmp = exports.DefaultComparator;
...
function groupByIndexed(inparr0, indexer) {
    if (!inparr0)
        return inparr0;
    var inparr = Object.values(inparr0);
    var resarr = [];
...
exports.groupByIndexed = groupByIndexed;
function groupBy2Indexed(inparr0, indexer) {
    if (!inparr0)
        return inparr0;
    var inparr = Object.values(inparr0);
    var resarr = [];
...
exports.groupBy2Indexed = groupBy2Indexed;
