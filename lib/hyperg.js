...
function indexOfArray(arr, value, cmp) {
    var res = -1;
    if (!cmp)
...
function removeArrayItemOnce(arr, value, cmp) {
    if (!cmp)
        cmp = exports.DefaultComparator;
