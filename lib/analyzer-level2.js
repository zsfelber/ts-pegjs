...
var CompressParseTable = /** @class */ (function () {
    function CompressParseTable(parseTable, log, info) {
                ...
                if (top) {
                    ...
                    for (i = 0; this.unresolvedRecursiveBoxes.length && i < 100; i++) {
                        ...
                        var unresolvedRecursiveBoxesNowProc = _1.groupByIndexed(unresolvedRecursiveBoxesNow, function (a) {
                            return a[0][_1.UNIQUE_OBJECT_ID];
                        });
                        var childrenAffctd = 0;
                        unresolvedRecursiveBoxesNowProc.forEach(function (group) {
                            var gimp = group[0][0];
...
var GenerateParseTableStackBox = /** @class */ (function () {
    ...
    GenerateParseTableStackBox.prototype.resetShitsToTrivial = function () {
        ...
        esths.forEach(function (_a) {
            ...
            shifts.forEach(function (shift) {
                var shift2 = new _1.gRTShift(shift.shiftIndex, shift.toStateIndex, tokenId);
