...
var CompressParseTable = /** @class */ (function () {
    ...
    CompressParseTable.prototype.pack = function () {
        ...
        _1.Analysis.serializedParseTables[this.parseTable.packedIndex] = { index: this.parseTable.packedIndex,
...
var GenerateParseTableStackBox = /** @class */ (function () {
    ...
    GenerateParseTableStackBox.prototype.generateShifts = function (phase) {
        ...
        var shi = 0;
        es.forEach(function (_a) {
            var key = _a[0], shs0 = _a[1];
            var tokenId = Number(key);
            var shs = shifts.map[tokenId];
            if (!shs) {
                shifts.map[tokenId] = shs = [];
            }
            var shsv0 = _1.distinct(Object.values(shs0), function (a, b) { return a.generationSecondaryIndex - b.generationSecondaryIndex; });
            shsv0.forEach(function (sh0) {
                var sh = new _1.RTShift(shi, sh0.toStateIndex, sh0.stepIntoRecursive);
                shs.push(sh);
                shi++;
            });
        });
        var lastTokens = Object.keys(shifts.map);
        lastTokens.sort(index_1.DefaultComparator);
    ...
    GenerateParseTableStackBox.prototype.appendChild = function (child, recursiveShift, rr) {
        ...
        es.forEach(function (_a) {
            ...
            var min = _1.minimum(childShiftsv, function (a, b) {
