...
var ParseTable = /** @class */ (function () {
    ...
    ParseTable.prototype.pack = function (log, info) {
        if (log === void 0) { log = true; }
        if (info === void 0) { info = ""; }
        var result;
        if (!this.packed) {
            var comp = new _1.CompressParseTable(this, log, info);
            result = comp.pack();
            this.packed = true;
        }
        return result;
    ...
    ParseTable.prototype.ser = function (mode) {
        ...
        switch (mode) {
            case _1.HyperGEnvType.ANALYZING:
                myc = _1.distinct(Object.values(this.myCommons), function (a, b) { return (a.replacedIndex - b.replacedIndex); });
                als = _1.distinct(Object.values(this.allStates), function (a, b) { return (a.replacedIndex - b.replacedIndex); });
                break;
            default:
...
var gRTShift = /** @class */ (function (_super) {
    ...
    function gRTShift(shiftIndex, toStateIndex, tokenId, stepIntoRecursive) {
        var _this = _super.call(this, shiftIndex, toStateIndex, stepIntoRecursive) || this;
...
var gGrammarParsingLeafStateTransitions = /** @class */ (function (_super) {
    ...
    gGrammarParsingLeafStateTransitions.prototype.fixedClone = function () {
        ...
        slots.forEach(function (slot) {
            Object.values(slot).forEach(function (shift) {
