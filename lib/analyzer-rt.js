...
var GenerateParseTableStackOpenerTransitions = /** @class */ (function () {
    function GenerateParseTableStackOpenerTransitions(parseTable, rr, parentStack) {
        this.parseTable = parseTable;
        this.rr = rr;
    ...
    GenerateParseTableStackOpenerTransitions.prototype.generate = function () {
        ...
        this.parseTable.myCommons.forEach(function (c) {
            if (c.filledWithRecursive) {
                ...
                if (_this.rr || c === _this.parseTable.startingState.common) {
                ...
                var forNode = new GenerateParseTableStackOpenerBoxTransitions(_this.parseTable, c, childStack);
                forNode.generate();
                if (c === _this.parseTable.startingState.common) {
...
var GenerateParseTableStackOpenerBoxTransitions = /** @class */ (function () {
    function GenerateParseTableStackOpenerBoxTransitions(parseTable, common, stack) {
        this.uniqShIdx = [];
        this.parseTable = parseTable;
        this.common = common;
        this.stack = stack;
