...
var ParseTable = /** @class */ (function () {
    ...
    ParseTable.prototype.pack = function (roundIdx, log) {
        if (roundIdx === void 0) { roundIdx = 0; }
    ...
    ParseTable.prototype.packagain = function (roundIdx, log) {
        if (roundIdx === void 0) { roundIdx = 0; }
        if (log === void 0) { log = true; }
...
var ReindexAndCompressMoreParseTable = /** @class */ (function () {
    function ReindexAndCompressMoreParseTable(parseTable, roundIdx, log) {
        if (roundIdx === void 0) { roundIdx = 0; }
        if (log === void 0) { log = true; }
        this.roundIdx = 0;
        this.log = true;
        ...
        if (shiftses.length) {
            shiftses.forEach(function (_a) {
                ...
                shs.forEach(function (sh) {
                    // 2 - based
                    var state = _this.parseTable.allStates[sh.toStateIndex - 2];
                    if (state) {
