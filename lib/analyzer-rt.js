...
var ParseTable = /** @class */ (function () {
    ...
    ParseTable.prototype.fillStackOpenerTransitions = function (phase, log) {
        ...
        if (!this.openerTrans) {
            this.openerTrans = new GenerateParseTableStackOpenerTransitions(null, this);
        }
...
var GenerateParseTableStackOpenerTransitions = /** @class */ (function () {
    function GenerateParseTableStackOpenerTransitions(parent, parseTable, rr) {
        this.indent = "";
        this.unresolvedNoTokenProducingRecursiveItems = [];
        this.children = [];
        this.parseTable = parseTable;
        this.rr = rr;
        this.stack = {};
    ...
    GenerateParseTableStackOpenerTransitions.prototype.generate = function (phase) {
        var _this = this;
        ...
        switch (phase) {
            case 0:
                ...
                this.parseTable.myCommons.forEach(function (c) {
                    ...
                    if (!c.filledWithRecursive) {
                        var forNode = new GenerateParseTableStackOpenerBoxTransitions(_this, _this.parseTable, c);
                        _this.children.push(forNode);
                        if (c === _this.parseTable.startingState.common) {
                            _this.shifts = forNode.shifts;
                        }
                        _this.stack = {};
                        Object.setPrototypeOf(_this.stack, olds);
                        _this.stack[_this.parseTable.rule.rule] = _this;
            ...
            case 5:
                if (top) {
                    ...
                    var childrenAffctd = [];
                    this.unresolvedNoTokenProducingRecursiveItems.forEach(function (tuple) {
...
var GenerateParseTableStackOpenerBoxTransitions = /** @class */ (function () {
    function GenerateParseTableStackOpenerBoxTransitions(parent, parseTable, common) {
        this.children = [];
        this.parent = parent;
        this.top = parent.top;
        this.parseTable = parseTable;
    ...
    GenerateParseTableStackOpenerBoxTransitions.prototype.generate = function (phase) {
        var _this = this;
        switch (phase) {
            case 0:
                ...
                esths.forEach(function (_a) {
                    ...
                    shifts.forEach(function (shift) {
                        _this.newShift(shift, [[tokenId, shift]]);
                    });
                });
                this.recursiveShifts = this.common.recursiveShifts.map[0];
                if (this.recursiveShifts) {
                    this.recursiveShifts.forEach(function (shift) {
                        _this.insertStackOpenShifts(phase, shift);
                    });
                }
                break;
            case 1:
    ...
    GenerateParseTableStackOpenerBoxTransitions.prototype.generateShiftsAgain = function (phase) {
    ...
    GenerateParseTableStackOpenerBoxTransitions.prototype.newShift = function (oldShift, theShifts) {
        var buf = [];
        ...
        if (olditm) {
            ...
            this.allShifts[key] = [oldShift.shiftIndex, theShifts];
        }
    };
    GenerateParseTableStackOpenerBoxTransitions.prototype.generateShifts = function (phase) {
        var _this = this;
        // doing it in-place to avoid updates over and over
        this.shifts.clear();
        var asvals = Object.values(this.allShifts);
        var shifstlen = asvals.length;
        asvals = index_1.distinct(asvals, function (a, b) {
            return a[0] - b[0];
        });
        if (shifstlen !== asvals.length) {
            throw new Error("shifstlen !== asvals.length   " + shifstlen + " !== " + asvals.length);
        }
        var shis = 0;
        asvals.forEach(function (_a) {
    ...
    GenerateParseTableStackOpenerBoxTransitions.prototype.insertStackOpenShifts = function (phase, recursiveShift) {
        ...
        switch (phase) {
            case 0:
                ...
                if (this.parent.stack[rr.rule]) {
                    // Trivial items :
                    this.appendChild(this.parent.stack[rr.rule], recursiveShift, rr);
                    this.top.unresolvedNoTokenProducingRecursiveItems.push([this, this.parent.stack[rr.rule], recursiveShift, rr]);
                }
                else {
    ...
    GenerateParseTableStackOpenerBoxTransitions.prototype.postfixInsertUnresolvedNoTokenProducing = function (child, recursiveShift, rr) {
        this.appendChild(child, recursiveShift, rr);
    };
    GenerateParseTableStackOpenerBoxTransitions.prototype.appendChild = function (child, recursiveShift, rr) {
        ...
        this.newShift(recursiveShift, impshifts);
    };
