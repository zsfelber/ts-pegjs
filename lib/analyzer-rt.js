...
var ParseTable = /** @class */ (function () {
    ...
    ParseTable.prototype.ser = function () {
        ...
        var serStates = [];
        var myc = _1.distinct(Object.values(this.myCommons), function (a, b) { return (a.replacedIndex - b.replacedIndex); });
        var als = _1.distinct(Object.values(this.allStates), function (a, b) { return (a.replacedIndex - b.replacedIndex); });
