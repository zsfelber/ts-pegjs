            ...
            case 0:
                ...
                this.parseTable.myCommons.forEach(function (c) {
                    ...
                    if (!c.filledWithRecursive) {
                        var stack = {};
                        stack[_this.parseTable.rule.rule] = _this;
                        Object.setPrototypeOf(stack, _this.stack);
                        var forNode = new GenerateParseTableStackBox(_this, _this.parseTable, c, stack);
...
var GenerateParseTableStackBox = /** @class */ (function () {
    ...
    GenerateParseTableStackBox.prototype.postfixInsertUnresolvedNoTokenProducing = function (child, recursiveShift, rr) {
