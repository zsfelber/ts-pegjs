...
var ParseTable = /** @class */ (function () {
    ...
    ParseTable.prototype.pack = function () {
        ...
        function prstate(state) {
            ...
            var tuple = [spidx, state.reduceActions.index, state.common.index];
