...
var GenerateParseTableRuleBoxes = /** @class */ (function () {
    function GenerateParseTableRuleBoxes(parseTable) {
        this.recursionChecked = {};
        this.parseTable = parseTable;
    }
    GenerateParseTableRuleBoxes.prototype.generate = function () {
        var _this = this;
        this.parseTable.allStates.forEach(function (state) {
            _this.prstate(state);
        });
    };
    GenerateParseTableRuleBoxes.prototype.prstate = function (state) {
        this.prcmn(state.common);
    };
    GenerateParseTableRuleBoxes.prototype.prcmn = function (state) {
        // lazy
        state.transitions;
        this.tra(state.serialStateMap);
    };
    GenerateParseTableRuleBoxes.prototype.tra = function (trans) {
        var recursiveShifts = trans.map[0];
        recursiveShifts.forEach(function (shift) {
        });
    };
    return GenerateParseTableRuleBoxes;
}());
