        ...
        recursiveShifts.forEach(function (shift) {
            if (shift.toStateIndex) {
                ...
                if (!_this.parent.stack[rr.rule]) {
                    ...
                    var forRuleRef = new GenerateParseTableStackOpenerTransitions(importedTable, rr, _this.parent);
                    forRuleRef.generate();
                    _this.insertStackOpenShifts(shift, forRuleRef, rr);
                }
            }
        });
    };
    GenerateParseTableStackOpenerBoxTransitions.prototype.insertStackOpenShifts = function (recursiveShift, child, rr) {
