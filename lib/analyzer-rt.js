...
var GenerateParseTableStackOpenerTransitions = /** @class */ (function () {
    function GenerateParseTableStackOpenerTransitions(top, parseTable, rr, parentStack) {
        ...
        this.parseTable.myCommons.forEach(function (c) {
            if (c.filledWithRecursive) {
                if (c === _this.parseTable.startingState.common) {
                    _this.shifts = _this.parseTable.startingState.common.serialStateMap;
                    was1st = 1;
                }
                else {
                    wasNon1st = 1;
                ...
                var childStack = {};
                Object.setPrototypeOf(childStack, _this.parentStack);
                ...
                if (!top || c === _this.parseTable.startingState.common) {
                    childStack[_this.parseTable.rule.rule] = _this;
                    was1st = 1;
                }
                else {
                    wasNon1st = 1;
                }
                var forNode = new GenerateParseTableStackOpenerBoxTransitions(_this.top, _this.parseTable, c, childStack);
                forNode.generate();
                if (c === _this.parseTable.startingState.common) {
...
var GenerateParseTableStackOpenerBoxTransitions = /** @class */ (function () {
    function GenerateParseTableStackOpenerBoxTransitions(top, parseTable, common, stack) {
        this.uniqShIdx = [];
        this.top = top;
        this.parseTable = parseTable;
        this.common = common;
    ...
    GenerateParseTableStackOpenerBoxTransitions.prototype.newShift = function (oldShift, theShifts) {
        ...
        var buf = [];
        theShifts.forEach(function (theShift) {
            buf.push(theShift[0]);
            buf.push(theShift[1].toStateIndex);
            theShift[1].serStackItms(buf);
        });
