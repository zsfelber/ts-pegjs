...
var ParseTable = /** @class */ (function () {
    ...
    ParseTable.prototype.ser = function () {
        ...
        var serStates = [];
        var myc = index_1.distinct(Object.values(this.myCommons), function (a, b) { return (a.replacedIndex - b.replacedIndex); });
        var als = index_1.distinct(Object.values(this.allStates), function (a, b) { return (a.replacedIndex - b.replacedIndex); });
