...
var GenerateParseTableStackOpenerBoxTransitions = /** @class */ (function () {
    ...
    GenerateParseTableStackOpenerBoxTransitions.prototype.generate = function () {
        ...
        esths.forEach(function (_a) {
            ...
            shifts.forEach(function (shift) {
                if (_this.uniqShIdx[shift.shiftIndex]) {
                    throw new Error("uniqShIdx[shift.shiftIndex]  uniqShIdx[" + shift.shiftIndex + "]");
                }
                _this.uniqShIdx[shift.shiftIndex] = 1;
                _this.allShifts.push([shift.shiftIndex, [[tokenId, shift]]]);
            });
        });
    ...
    GenerateParseTableStackOpenerBoxTransitions.prototype.generateShifts = function () {
        ...
        this.allShifts = index_1.distinct(this.allShifts, function (a, b) {
            return a[0] - b[0];
        });
        ...
        var oldshis = 0;
        var shis = 0;
        this.allShifts.forEach(function (_a) {
