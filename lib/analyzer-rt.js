            ...
            case 0:
                ...
                this.parseTable.myCommons.forEach(function (c) {
                    ...
                    if (!c.filledWithRecursive) {
                        ...
                        if (stack[_this.parseTable.rule.rule] !== _this) {
                            throw new Error("stack[this.parseTable.rule.rule:'" + _this.parseTable.rule.rule + "'] !== this   " + stack[_this.parseTable.rule.rule] + " !== " + _this);
                        }
