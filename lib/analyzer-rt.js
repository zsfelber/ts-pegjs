...
var GenerateParseTableStackOpenerTransitions = /** @class */ (function () {
    ...
    GenerateParseTableStackOpenerTransitions.prototype.generate = function () {
        var _this = this;
        console.log(this.indent + ">" + (this.rr ? this.rr : this.parseTable.rule));
...
var GenerateParseTableStackOpenerBoxTransitions = /** @class */ (function () {
    ...
    GenerateParseTableStackOpenerBoxTransitions.prototype.generate = function () {
        ...
        if (recursiveShifts) {
            recursiveShifts.forEach(function (shift) {
                _this.insertStackOpenShifts(shift);
            });
        }
        // maybe re-generated but should not produce more transition tokens !
        this.generateShifts();
    };
    GenerateParseTableStackOpenerBoxTransitions.prototype.generateShiftsAgain = function () {
    ...
    GenerateParseTableStackOpenerBoxTransitions.prototype.newShift = function (oldShift, theShifts) {
        if (this.uniqShIdx[oldShift.shiftIndex]) {
            throw new Error("uniqShIdx[shift.shiftIndex]  uniqShIdx[" + oldShift.shiftIndex + "]");
        }
        this.uniqShIdx[oldShift.shiftIndex] = 1;
        var buf = [];
    ...
    GenerateParseTableStackOpenerBoxTransitions.prototype.generateShifts = function () {
        var _this = this;
    ...
    GenerateParseTableStackOpenerBoxTransitions.prototype.insertStackOpenShifts = function (recursiveShift) {
