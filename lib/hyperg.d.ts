...
export declare function indexOfArray<T>(arr: T[], value: T, cmp?: ((a: T, b: T) => number)): number;
export declare function removeArrayItemOnce<T>(arr: T[], value: T, cmp?: ((a: T, b: T) => number)): T[];
