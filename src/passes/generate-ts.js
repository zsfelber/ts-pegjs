    ...
    return super.expectLowerCase(rule, expectedText);
        ...
        parts.push(
            [
                ...
                '    } else {',
                '       this.found = this.peg$foundErrorLiteral();',
        ...
        parts.push(
            [
                ...
                '    return    this.input.isAvailableAt(this.peg$maxFailPos)',
                ...
                '    mergeFailures(this, { peg$maxFailExpected: [ expected1 ],',
                '                          peg$maxFailPos:      this.inputBuf.currPos });',
                '  }',
                '',
