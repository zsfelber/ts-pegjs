...
function generateTS(ast, ...args) {
  ...
  function generateToplevel() {
    ...
    parts.push([
      "function peg$parse<I extends IParseStream>("+param0+"input: I, options?: IParseOptions) {",
  ...
  function generateWrapper(toplevelCode) {
    function generateGeneratedByComment() {
      ...
      res = res.concat([
        "import {IFilePosition, IFileRange, ILiteralExpectation, IClassParts, IClassExpectation, IAnyExpectation, IEndExpectation, IOtherExpectation, Expectation, SyntaxError, ITraceEvent, DefaultTracer, ICached, IParseOptions, IPegjsParseStream, PegjsParseStream} from 'ts-pegjs/lib';",
        "",
  ...
  expectLowerCase(rule: RuleId, expectedText: string): boolean {
    return super.expectLowerCase(rule, expectedText);
      ...
      const parseFunctionType = "export type ParseFunction = <I extends IParseStream>("+param0+"input: I, options?: IParseOptions) => any;";
